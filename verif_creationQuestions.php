...
<?php
  if(isset($_POST["Question"]) && !empty($_POST["Question"]) && isset($_POST["reponse1"]) && !empty($_POST["reponse1"]) && isset($_POST["reponse2"]) && !empty($_POST["reponse2"]) && isset($_POST["reponse3"]) && !empty($_POST["reponse3"]) && isset($_POST["reponse4"]) && !empty($_POST["reponse4"]) && isset($_POST["choix"]) && !empty($_POST["choix"]) && isset($_POST["idQuizz"]) && !empty($_POST["idQuizz"]))
  {
