...
if(!empty( $_POST["password"]) && isset( $_POST["password"]) && !empty($_POST["nom"]) && isset($_POST["nom"]) 
&& !empty($_POST["prenom"]) && isset($_POST["prenom"]) && isset($_POST["mail"]) && !empty($_POST["mail"])){
	//on récupère les paramètres passés en post dans le formulaire
	...
	//on crée la session du nouvel utilisateur
